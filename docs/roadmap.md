...
- [x] Définir un SDK minimal pour ajouter des collecteurs (ex : vérifier certificats, services custom).
- [x] Interface CLI `describe-me plugin run` et routage des métriques supplémentaires vers l’UI.
